...
import com.uninter.ads.back_end.model.service.ClienteService;
...
@RequestMapping(value={"/clientes" /*, "clientes/"*/})
public class ClienteController {
	...
	@PostMapping
	public ResponseEntity<?> create(@Valid @RequestBody Cliente item) {
		Cliente itemCriado = service.create(item);
	...
	@PutMapping(value = "/{id}")
	public ResponseEntity<?> update(@PathVariable("id") Long id, @Valid @RequestBody Cliente item) {
		Cliente updated = service.update(id, item);
